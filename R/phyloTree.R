...
#' V, D, and J gene usage.  The number next to each leaf refers to the sequence duplicate_count.
#' A triangle shaped leaf indicates the dominant sequence. Refer to the ggtree Bioconductor package 
